...
export default async function Page({searchParams}:{searchParams:Promise<{organisation?:string}>}){
 ...
 {!fresh&&<section className="notice" role="status"><strong>Confirmez votre identité pour gérer les accès.</strong><p>Votre session permet de consulter cette page. Pour inviter, accepter une demande ou modifier un rôle, reconnectez-vous. Vous retrouverez l’accueil de votre association, puis pourrez rouvrir cette rubrique.</p><Link className="button" href={reconnect}>Confirmer mon identité</Link></section>}
