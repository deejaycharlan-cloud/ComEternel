...
export const templateSteps = [
  ...
  { key: 'teaser', title: 'Créer un teaser vidéo (facultatif)', offset: -10, format: 'Teaser', profession: 'monteur', description: 'Annoncer l’événement avec une courte vidéo. Déposer la version dans Livrables, puis préparer sa validation et sa date de publication.', packs: ['standard','extended'], optional: true },
  { key: 'social', title: 'Décliner le flyer et les slides pour les réseaux', offset: -7, format: 'Flyer / story / slides', profession: 'infographiste', description: 'Préparer les formats utiles dans Livrables et convenir des échéances avec la personne chargée de publication.', packs: ['standard','extended'], optional: false },
  ...
  { key: 'capture', title: 'Capter l’événement et déposer les rushs', offset: 0, format: 'Collecte', profession: 'photographe', description: 'Pendant ou après l’événement, déposer les photos et vidéos originales dans Rushs. Préparer les consignes et autorisations en amont.', packs: ['standard','extended'], optional: false },
  ...
  { key: 'interview', title: 'Monter une interview (facultatif)', offset: 5, format: 'Interview', profession: 'monteur', description: 'Utiliser les rushs autorisés, déposer le montage dans Livrables et le faire valider avant diffusion.', packs: ['extended'], optional: true },
